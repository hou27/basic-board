...
import com.hou27.basicboard.repository.ArticleCommentRepository;
...
@DisplayName("Article Comment Service Test")
...
class ArticleCommentServiceTest {
  ...
  void givenArticleCommentInfo_whenSavingArticleComment_thenSavesArticleComment() {
    // Given
    ArticleCommentDto dto = createArticleCommentDto("comment content");
    given(articleRepository.getReferenceById(dto.articleId())).willReturn(createArticle());
    given(articleCommentRepository.save(any(Comment.class))).willReturn(null);
    ...
    then(articleCommentRepository).should().save(any(Comment.class));
  }
  ...
  private Comment createArticleComment(String content) {
    return Comment.of(
        Article.of( "title", "content", createAccount(),"hashtag"),
        createAccount(),
        content
    );
  }
